...
//	}
	...
	void seteyeL(Graphics g) {
		...
		g.fillRoundRect(eye.getPartsL("x",0, LEFT),eye.getPartsL("y",0, LEFT),eye_w,eye_h ,body_aw_L,body_ah_L);//eye 左1
		g.setColor(Color.white);
		g.fillArc(eye.getPartsL("x", 0, LEFT),eye.getPartsL("y", 0, LEFT),eye_w,eye_h ,body_aw_L,body_ah_L);//eye 左2
		g.setColor(Color.blue);
		g.fillArc(eye.getPartsL("x",0, LEFT)-(eye_w)/2,eye.getPartsL("y",0, LEFT)-(eye_h)/2,eye_w+8,eye_h+8 ,0,180);//eye 2 瞼
	}
	...
	void seteyeR(Graphics g) {
		//右目描画
		g.setColor(Color.black);
		g.fillRoundRect(eye.getPartsR("x",0, LEFT),eye.getPartsR("y",0, LEFT),eye_w,eye_h ,body_aw_L,body_ah_L);//eye 右1
		g.setColor(Color.white);
		g.fillArc(eye.getPartsR("x",0, LEFT),eye.getPartsR("y",0, LEFT),eye_w,eye_h ,body_aw_L,body_ah_L);//eye 右2
		g.setColor(Color.blue);
		g.fillArc(eye.getPartsR("x",0, LEFT)-(eye_w)/2,eye.getPartsR("y",0, LEFT)-(eye_h)/2,eye_w+8,eye_h+8 ,0,180);//eye 2 瞼
	}
	...
	void setbody(Graphics g) {
		...
		//体描画
		g.fillRoundRect(body.getparts("x", 0, LEFT),body.getparts("y", 0, LEFT),body_w_L,body_h_L ,body_aw_L,body_ah_L);//body
	}
	...
	void setarmL(Graphics g) {
		//左腕描画
		g.setColor(Color.black);
		g.drawLine(arm.getPartsL("x", 0, LEFT),arm.getPartsL("y", 0, LEFT),arm.getPartsL("x", 1, LEFT),arm.getPartsL("y", 1, LEFT));//左腕
		g.setColor(Color.white);
		g.fillArc(arm.getPartsL("x", 1, LEFT)-hand_h/2,arm.getPartsL("y", 1, LEFT)-hand_w/2, hand_w,hand_h,0,360);//左手
		g.setColor(Color.black);
		g.drawArc(arm.getPartsL("x", 1, LEFT)-hand_h/2,arm.getPartsL("y", 1, LEFT)-hand_w/2, hand_w,hand_h,0,360);//左手
	}
	...
	void setarmR(Graphics g) {
		//右腕描画
		g.setColor(Color.black);
		g.drawLine(arm.getPartsR("x", 0, LEFT),arm.getPartsR("y", 0, LEFT),arm.getPartsR("x", 1, LEFT),arm.getPartsR("y", 1, LEFT));//右腕
		g.setColor(Color.white);
		g.fillArc(arm.getPartsR("x", 1, LEFT)-hand_h/2,arm.getPartsR("y", 1, LEFT)-hand_w/2, hand_w,hand_h,0,360);//右手
		g.setColor(Color.black);
		g.drawArc(arm.getPartsR("x", 1, LEFT)-hand_h/2,arm.getPartsR("y", 1, LEFT)-hand_w/2, hand_w,hand_h,0,360);//右手
	}
	...
	void setlegL(Graphics g) {
		g.setColor(Color.black);
		g.drawLine(leg.getPartsL("x", 0 , LEFT),leg.getPartsL("y", 0 , LEFT),leg.getPartsL("x", 1 , LEFT),leg.getPartsL("y", 1 , LEFT));
	}
	...
	void setlegR(Graphics g) {
		g.setColor(Color.black);
		g.drawLine(leg.getPartsR("x", 0, LEFT),leg.getPartsR("y", 0, LEFT),leg.getPartsR("x", 1, LEFT),leg.getPartsR("y", 1, LEFT));
	}
